...
local entries={}
local catalog_1=require "contracts.families.ef00.bridges_wave19"
for _,entry in ipairs(registrations(catalog_1,"ef00.bridges.wave19","contracts.families.ef00.bridges_wave19"))do
