...
custom_capabilities.enum = build({ { "battery_low", "battery_low", "concertmirror08464.batteryLow", "batteryLow", nil, "setBatteryLow", "batteryLow", "battery_low", "Battery low", { "normal", "low" } }, { "security_remote_action", "security_remote_action", "concertmirror08464.securityRemoteAction", "securityRemoteAction", "supportedSecurityRemoteActions", "setSecurityRemoteAction", "securityRemoteAction", "security_remote_action", "Security remote action", { "disarm", "arm_day_zones", "arm_night_zones", "arm_all_zones", "exit_delay", "emergency" } }, { "foriaSceneBacklight", nil, "concertmirror08464.foriaSceneBacklight", "foriaSceneBacklight", nil, "setForiaSceneBacklight", "foriaSceneBacklight", "foria_scene_backlight", "Foria Scene Backlight", { "off", "on" } }, { "foriaSceneIlluminationDetection", nil, "concertmirror08464.foriaSceneIlluminationDetection", "foriaSceneIlluminationDetection", nil, "setForiaSceneIlluminationDetection", "foriaSceneIlluminationDetection", "foria_scene_illumination_detection", "Foria Scene Illumination Detection", { "off", "on" } }, { "foriaSceneApproachDetection", nil, "concertmirror08464.foriaSceneApproachDetection", "foriaSceneApproachDetection", nil, "setForiaSceneApproachDetection", "foriaSceneApproachDetection", "foria_scene_approach_detection", "Foria Scene Approach Detection", { "off", "on" } }, { "foriaSceneVibration", nil, "concertmirror08464.foriaSceneVibration", "foriaSceneVibration", nil, "setForiaSceneVibration", "foriaSceneVibration", "foria_scene_vibration", "Foria Scene Vibration", { "off", "on" } } }, enum)
