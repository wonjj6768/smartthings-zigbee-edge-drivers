...
local entries={}
local catalog_1=require "contracts.families.ef00.controls"
for _,entry in ipairs(registrations(catalog_1,"ef00.controls","contracts.families.ef00.controls"))do
