...
local entries={}
local catalog_1=require "contracts.families.ef00.din_rail.energy"
for _,entry in ipairs(registrations(catalog_1,"ef00.din_rail.energy","contracts.families.ef00.din_rail.energy"))do
