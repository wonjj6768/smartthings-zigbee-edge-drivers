...
local entries={}
local catalog_1=require "contracts.families.ef00.garage_doors"
for _,entry in ipairs(registrations(catalog_1,"ef00.garage_doors","contracts.families.ef00.garage_doors"))do
