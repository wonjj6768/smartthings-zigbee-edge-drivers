...
local strings={"s","garageRunTimeCountdownOpener120","capmjohqwokmotdvrfcfvaf","run_time","Garage Run Time Countdown Opener120","garageOpenAlarmTimeOpenerDay","open_alarm_time","Garage Open Alarm Time Opener Day","garageOpenerCountdown","countdown","Garage Opener Countdown","garageStatusCountdownOpenerAlarm","garage_status","Garage Status Countdown Opener Alarm","open_time_alarm","run_time_alarm","normal","last_power_response_time","lastPowerResponseTime","Last power response time"}
...
custom_capabilities.numeric=build({{2,nil,2,3,nil,nil,nil,4,5,{0,120,1,1,nil,1,nil},nil,nil,1},{6,nil,6,6,nil,nil,nil,7,8,{0,86400,1,1,nil,2,nil},nil,nil,1},{9,nil,9,10,nil,nil,nil,10,11,{0,43200,1,1,nil,3,nil},nil,nil,1}},numeric)
custom_capabilities.enum=build({{12,nil,12,12,nil,0,0,13,14,{15,16,17},{15,16,17},4,5,4}},enum)
custom_capabilities.text=build({{18,19,19,0,0,nil,20,64}},text)
