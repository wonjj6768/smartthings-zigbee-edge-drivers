...
local entries={}
local catalog_1=require "contracts.families.ef00.motion_pir"
for _,entry in ipairs(registrations(catalog_1,"ef00.motion_pir","contracts.families.ef00.motion_pir"))do
