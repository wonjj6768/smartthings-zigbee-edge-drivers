...
local entries={}
local catalog_1=require "contracts.families.ef00.presence.advanced"
for _,entry in ipairs(registrations(catalog_1,"ef00.presence.advanced","contracts.families.ef00.presence.advanced"))do
