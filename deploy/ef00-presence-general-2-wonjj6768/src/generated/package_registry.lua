...
local entries={}
local catalog_1=require "contracts.families.ef00.presence.general_2"
for _,entry in ipairs(registrations(catalog_1,"ef00.presence.general.2","contracts.families.ef00.presence.general_2"))do
