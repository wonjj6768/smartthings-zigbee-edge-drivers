...
local entries={}
local catalog_1=require "contracts.families.ef00.presence.switch"
for _,entry in ipairs(registrations(catalog_1,"ef00.presence.switch","contracts.families.ef00.presence.switch"))do
