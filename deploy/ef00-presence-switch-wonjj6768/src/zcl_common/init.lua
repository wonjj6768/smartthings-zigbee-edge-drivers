...
function zcl.illuminance(options)
  local mapping = zcl.cluster_attribute(zcl.CLUSTER_ILLUMINANCE, zcl.ATTR_MEASURED_VALUE, options or {})
  if mapping.name == nil then mapping.name = "illuminance" end
  return mapping
end
