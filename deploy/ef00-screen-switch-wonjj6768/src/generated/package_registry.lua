...
local entries={}
local catalog_1=require "contracts.families.ef00.screen_switches"
for _,entry in ipairs(registrations(catalog_1,"ef00.screen_switches","contracts.families.ef00.screen_switches"))do
