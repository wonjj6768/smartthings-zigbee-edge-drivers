...
local entries={}
local catalog_1=require "contracts.families.ef00.switch_panel"
for _,entry in ipairs(registrations(catalog_1,"ef00.switch.panel","contracts.families.ef00.switch_panel"))do
