...
local entries={}
local catalog_1=require "contracts.families.ef00.switch_basic"
for _,entry in ipairs(registrations(catalog_1,"ef00.switch.basic","contracts.families.ef00.switch_basic"))do
