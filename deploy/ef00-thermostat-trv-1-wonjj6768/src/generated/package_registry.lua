...
local entries={}
local catalog_1=require "contracts.families.ef00.thermostats.trv_1"
for _,entry in ipairs(registrations(catalog_1,"ef00.thermostats.trv_1","contracts.families.ef00.thermostats.trv_1"))do
