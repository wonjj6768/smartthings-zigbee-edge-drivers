...
local entries={}
local catalog_1=require "contracts.families.ef00.thermostats.trv_2"
for _,entry in ipairs(registrations(catalog_1,"ef00.thermostats.trv_2","contracts.families.ef00.thermostats.trv_2"))do
