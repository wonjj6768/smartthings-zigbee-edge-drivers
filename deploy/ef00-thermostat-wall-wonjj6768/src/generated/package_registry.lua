...
local entries={}
local catalog_1=require "contracts.families.ef00.thermostats.wall"
for _,entry in ipairs(registrations(catalog_1,"ef00.thermostats.wall","contracts.families.ef00.thermostats.wall"))do
