...
local strings={"wetenPciRestartMode","restartMode","weten_pci_restart_mode","Weten Pci Restart Mode","restart","force restart","–","wetenPciRfRemoteControl","rfRemoteControl","weten_pci_rf_remote_control","Weten Pci Rf Remote Control","ON","OFF","wetenPciRfPairing","rfPairing","weten_pci_rf_pairing","Weten Pci Rf Pairing","wetenPciBuzzerFeedback","buzzerFeedback","weten_pci_buzzer_feedback","Weten Pci Buzzer Feedback","wetenPciPowerOnBehavior","powerOnBehavior","weten_pci_power_on_behavior","Weten Pci Power On Behavior","off","on","wetenPciChildLock","childLock","weten_pci_child_lock","Weten Pci Child Lock","LOCK","UNLOCK","last_power_response_time","lastPowerResponseTime","Last power response time"}
...
custom_capabilities.enum=build({{1,nil,1,2,nil,nil,nil,3,4,{5,6,7},{5,6,7},1,2,1},{8,nil,8,9,nil,nil,nil,10,11,{12,13},{12,13},3,4,3},{14,nil,14,15,nil,nil,nil,16,17,{12,13},{12,13},5,6,5},{18,nil,18,19,nil,nil,nil,20,21,{12,13},{12,13},7,8,7},{22,nil,22,23,nil,nil,nil,24,25,{26,27},{26,27},9,10,9},{28,nil,28,29,nil,nil,nil,30,31,{32,33},{32,33},11,12,11}},enum)
custom_capabilities.text=build({{34,35,35,0,0,nil,36,64}},text)
