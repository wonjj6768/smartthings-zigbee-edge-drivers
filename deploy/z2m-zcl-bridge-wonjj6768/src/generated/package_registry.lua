...
local entries={}
local catalog_1=require "contracts.families.zcl.bridges_wave19"
for _,entry in ipairs(registrations(catalog_1,"zcl.bridges.wave19","contracts.families.zcl.bridges_wave19"))do
