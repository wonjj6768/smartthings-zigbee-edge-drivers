...
local entries={}
local catalog_1=require "contracts.families.zcl.lights.wave19_dali"
for _,entry in ipairs(registrations(catalog_1,"zcl.lights.wave19_dali","contracts.families.zcl.lights.wave19_dali"))do
