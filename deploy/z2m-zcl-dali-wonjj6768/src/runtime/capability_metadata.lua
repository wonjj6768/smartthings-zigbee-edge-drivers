...
local strings={"last_power_response_time","lastPowerResponseTime","Last power response time"}
...
custom_capabilities.enum=build({},enum)
custom_capabilities.text=build({{1,2,2,0,0,nil,3,64}},text)
