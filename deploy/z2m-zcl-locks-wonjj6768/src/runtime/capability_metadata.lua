...
local strings={"javisSlkAction","action","javis_unlock_report","Javis Slk Action","unlock","lock","javisSlkState","state","javis_lock_state","Javis Slk State","LOCK","last_power_response_time","lastPowerResponseTime","Last power response time"}
...
custom_capabilities.enum=build({{1,nil,1,2,nil,0,0,3,4,{5,6},{5,6},1,2,1},{7,nil,7,8,nil,0,0,9,10,{11},{11},3,4,3}},enum)
custom_capabilities.text=build({{12,13,13,0,0,nil,14,64}},text)
