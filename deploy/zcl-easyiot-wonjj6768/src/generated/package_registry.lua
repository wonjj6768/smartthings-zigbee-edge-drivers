...
local entries={}
local catalog_1=require "contracts.families.zcl.switches.easyiot_absorption"
for _,entry in ipairs(registrations(catalog_1,"zcl.easyiot.absorption","contracts.families.zcl.switches.easyiot_absorption"))do
