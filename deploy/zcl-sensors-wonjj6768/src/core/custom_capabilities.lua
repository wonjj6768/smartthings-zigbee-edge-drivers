...
custom_capabilities.numeric = build({ { "presence_sensitivity", "presence_sensitivity", "concertmirror08464.presenceSensitivity", "presenceSensitivity", "presenceSensitivityRange", "setPresenceSensitivity", "presenceSensitivity", "presence_sensitivity", "Presence sensitivity", { 0, 10, 1, nil, nil }, nil, 10, nil }, { "power_poll_interval", "power_poll_interval", "concertmirror08464.powerPollIntervalV2", "powerPollInterval", "powerPollIntervalRange", "setPowerPollInterval", "powerPollInterval", "power_poll_interval", "Power poll interval", { 5, 3600, 5, "s", nil }, 5, 3600, "s" } }, numeric)
custom_capabilities.enum = build({ { "battery_low", "battery_low", "concertmirror08464.batteryLow", "batteryLow", nil, "setBatteryLow", "batteryLow", "battery_low", "Battery low", { "normal", "low" } } }, enum)
