...
-- Frozen Zigbee2MQTT v26.99.0 src/devices/moes.ts:206-274.
-- Brightness values are the raw 10..1000 device contract.  They must not be
-- routed through switchLevel's 0..100 percentage conversion.
