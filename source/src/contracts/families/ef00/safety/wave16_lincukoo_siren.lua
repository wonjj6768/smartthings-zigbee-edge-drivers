-- Wave16 Lincukoo A08-Z10T siren source-only candidate.
-- Frozen Zigbee2MQTT v26.99.0: src/devices/lincukoo.ts:703-790.
...
-- Frozen lookup produces a plain JS number, so alarm_state uses Tuya VALUE.
