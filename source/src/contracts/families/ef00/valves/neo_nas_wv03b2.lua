...
-- Frozen Z2M v26.99.0 src/devices/neo.ts:254-314.
-- This is deliberately kept separate from NAS-WV03B/NAS-WV05B2: DP101 is
-- on-with-countdown instead of water-total reset, and the measurement DPs are
-- absent from this family.
