-- Wave19 exact-only native/custom-ZCL light candidates.
-- Frozen Zigbee2MQTT v26.99.0:
--   src/devices/candeo.ts:1082-1143 Candeo C-ZB-RD1Pv2-DIM
--   src/devices/terncy.ts:716-776  TERNCY DIM003
...
local function candeo_action_resolver(zb_rx, cluster_id, command_id, source_endpoint)
  ...
  -- The frozen converter can decode commandOn as "pressed", but this exact
  -- definition intentionally exposes only double_pressed/held/released.
