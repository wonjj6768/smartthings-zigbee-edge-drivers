-- Protocol-neutral custom capability metadata.
...
local generated_family_capabilities = require "generated.custom_capabilities.families"
...
append_definitions(custom_capabilities.numeric, generated_family_capabilities.numeric)
append_definitions(custom_capabilities.enum, generated_family_capabilities.enum)
append_definitions(custom_capabilities.text, generated_family_capabilities.text)
